...
@WebServlet("/add-students-with-subject")
public class AddStudentWithSubject extends HttpServlet {
	
	private static final long serialVersionUID = 1L;

	public AddStudentWithSubject() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("add-students-with-payments.html").include(request, response);
	}
